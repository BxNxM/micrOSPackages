...
from color_sensor import shared                                                       # DEMO: shared features (WIP)
# TODO: Intention is to create isolated simple neopixel functions and move sensor independent features to shared module...
...
def neomatrix_animation():
    ...
    """
    return shared.neomatrix_animation()
