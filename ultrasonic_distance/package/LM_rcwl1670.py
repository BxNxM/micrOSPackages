...
SENSOR = None
SENSOR_NAME = "RCWL-1670"


def _sensor(trig_pin=16, echo_pin=17, timeout_us=40000, trigger_us=10, reset=False):
    global SENSOR
    ...
    if SENSOR is None:
        SENSOR = TriggerEchoSensor(
            ...
            trig_pin=trig_pin,
            echo_pin=echo_pin,
            trig_logical="rcwl1670_trig",
            echo_logical="rcwl1670_echo",
...
def load(trig_pin=16, echo_pin=17, timeout_us=40000, trigger_us=10, reset=False):
    """
    Create and cache the RCWL-1670 trigger/echo sensor.

    :param trig_pin int: MCU output connected to RX/TRIG, default: 16
    :param echo_pin int: MCU input connected to TX/ECHO, default: 17
...
def pinmap():
    ...
    """
    return pinmap_search(["rcwl1670_trig", "rcwl1670_echo"])
