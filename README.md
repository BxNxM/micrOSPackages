...
| <img src="./sim800/media/sim800.png" alt="sim800 illustration" width="72"> | [sim800](./sim800/README.md) | `sim800`<br>`sim800_http`<br>`sim800mqtt` | SIM800C voice, SMS, USSD, HTTP, and MQTT integration. |
